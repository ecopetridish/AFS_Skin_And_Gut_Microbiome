...
da1<-da1 + coord_cartesian(ylim=c(1,7), xlim=c(-4, 4)) +
  ...
  annotate("text", x = 3.5, y = Inf, hjust = 1, label = paste0("abundant in SSB"),
           vjust = 1, size = 6, family = "Arial") +
  scale_x_continuous(breaks=seq(-4,2,2))

## Skin - age
da2<-plot_forest(da_s_age_sf_coef, "mothers", "pups", "#7b3294", "#008837")
da2<-da2 + coord_cartesian(ylim=c(1,7)) +
  annotate("text", x = -1.8, y = Inf, hjust = 0, label = paste0("abundant in mothers"),
           vjust = 1, size = 6, family = "Arial") +
  scale_x_continuous(breaks=seq(-4,0,2))

## Gut - colony
da3<-plot_forest(da_g_col_sf_coef, "FWB", "SSB", "#6baed6", "#d95f0e")
da3<-da3 + annotate("text", x = -2.3, y = Inf, hjust = 0, label = paste0("abundant in FWB"),
                    vjust = 1, size = 6, family = "Arial") +
  annotate("text", x = 2.3, y = Inf, hjust = 1, label = paste0("abundant in SSB"),
           vjust = 1, size = 6, family = "Arial")
